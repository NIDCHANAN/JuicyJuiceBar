...
namespace CoreAdmin
{
    ...
    static public class Session
    {
        ...
        /// <summary>
        /// Gets or sets the dark mode of the session.
        /// <para>Represents a dark mode this application supports</para>
        /// </summary>
        static public string ThemeMode
        {
            get
            {
                string result = GetString("theme");
                return result != null ? result : "light";
            }
            set
            {
                if (value != null)
